...
def get_random() -> float:
    """
    Fetches a random decimal fraction with two decimal places between 0 and 0.99 from random.org.

    Returns:
        float: The random number fetched from random.org converted to float.
